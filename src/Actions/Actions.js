...
export const updatePostRequest = (postData) => {
	...
	return (dispatch) => {
		return api
			.patch(`post/${postData.id}`, postDataChange)
			.then((res) => {
...
//ACCOUNT MANAGER  ---- PRODUCTMANAGER----------------------------------------------------------------
...
//BILL MANAGER----------------------------------------
export const fetchBillDataRequest = () => {
	return (dispatch) => {
		console.log(1);
		return api
			.get('checkout')
			.then((res) => {
				...
				dispatch(fetchBillData(res.data));
			})
			.catch((error) => {
				console.log(error);
				alert('lỗi kết nối');
...
export const fetchBillData = (bill) => {
	console.log(2);
	return {
...
export const fetchFeedbackRequest = () => {
	return (dispatch) => {
		return api
			.get('feedback')
			.then((res) => {
				dispatch(fetchFeedback(res.data));
			})
			.catch((error) => {
				console.log(error);
				alert('lỗi kết nối');
...
export const fetchFeedback = (feedbacks) => {
	return {
...
export const deleteFeedbackRequest = (id) => {
	return (dispatch) => {
		return api
			.delete(`feedback/${id}`)
			.then((res) => {
