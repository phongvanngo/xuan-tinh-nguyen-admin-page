      ...
      showForm = (
        <div className="row">
          <div className="col-12">
            <div class="card">
              <div className="card-header">{this.props.itemSelected._id !== "" ? "Chỉnh sửa sản phẩm" : "Thêm sản phẩm "}</div>
              <div class="card-body">
              ...
              <div className="card-footer">
                <div style={{ marginRight: 10, float: 'right' }}>
                  <button onClick={  this.handleSubmit.bind(this) } type="submit" className="btn btn-primary" id="ex4" value="Submit">Xác nhận</button>
                  {this.state.alert}
                </div>
                <div style={{ marginRight: 10, float: 'right' }}>
                  <button onClick={() => this.onShowForm()} type="button" className="btn btn-dark" id="ex5">Hủy bỏ</button>
                </div>
              </div>
            </div>
          </div>
